...
(let ((bg "#1c1b1a")
  ...
  ;; ivy
   ...
   `(magit-diff-added ((t (:background ,lime :foreground ,bg))))
   `(magit-diff-added-highlight ((t (:background ,lime :foreground ,bg))))
   `(magit-diff-base ((t (:background ,dirtyblonde :foreground ,bg))))
   `(magit-diff-base-highlight ((t (:background ,dirtyblonde :foreground ,bg))))
   `(magit-diff-removed ((t (:background ,taffy :foreground ,bg))))
   `(magit-diff-removed-highlight ((t (:background ,taffy :foreground ,bg))))
